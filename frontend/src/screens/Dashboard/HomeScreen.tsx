...
const Dashboard: React.FC = () => {
  ...
  const menuItems = [
    { path: '/profile', label: '👤 Profil', permission: null as any },
    { path: '/orders', label: '🧾 Zlecenia', permission: 'canViewOrders' as any },
    { path: '/vehicles', label: '🚗 Pojazdy', permission: 'canViewVehicles' as any },
    { path: '/customers', label: '👥 Klienci', permission: 'canViewCustomers' as any },
    { path: '/calendar', label: '📅 Kalendarz', permission: 'canViewAppointments' as any },
    { path: '/warehouse', label: '📦 Magazyn', permission: 'canViewWarehouse' as any },
    { path: '/invoices', label: '🧾 Faktury', permission: 'canViewInvoices' as any },
    { path: '/messages', label: '💬 Wiadomości', permission: 'canViewMessages' as any },
    ...
    { path: '/admin/users', label: '👑 Admin', permission: 'canViewAdminPanel' as any },
  ]
        ...
        <section className="dashboard-grid">
          <div className="panel panel-wide">
            ...
            <div className="panel-actions">
              <button className="btn-primary" onClick={() => navigate('/calendar')}>Umów nową wizytę</button>
              {canViewOrders && (
                <button className="btn-secondary" onClick={() => navigate('/orders')}>Szczegóły</button>
              )}
            </div>

            <div className="quick-actions">
              <button className="btn-secondary" onClick={() => navigate('/search')}>🔍 Szybkie wyszukiwanie</button>
              <button className="btn-secondary" onClick={() => navigate('/messages')}>💬 Wiadomości</button>
              {canViewWarehouse && (
                <button className="btn-secondary" onClick={() => navigate('/warehouse')}>📦 Magazyn</button>
              )}
            </div>
          </div>
            ...
            {isClient ? (
              <>
                <div className="panel-header">
                  ...
                  <button className="btn-secondary" onClick={() => navigate('/calendar')}>Umów wizytę</button>
                </div>
              ...
              <>
                ...
                <div className="panel-actions">
                  {(canViewWarehouse || canViewInvoices) && (
                    <>
                      {canViewWarehouse && (
                        <button className="btn-secondary" onClick={() => navigate('/warehouse')}>Sprawdź magazyn</button>
                      )}
                      {canViewInvoices && (
                        <button className="btn-secondary" onClick={() => navigate('/invoices')}>Faktury</button>
                      )}
                    </>
                  )}
                </div>
