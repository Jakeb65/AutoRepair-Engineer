    ...
    <div className="invoices-container">
      <div className="invoices-header">
        ...
        <div className="invoices-actions">
          ...
          />
          <select className="invoices-select" value={status} onChange={(e) => setStatus(e.target.value as FilterStatus)}>
          ...
          <button className="invoices-button-primary" onClick={() => setOpenCreate(true)}>
            ➕ Wystaw fakturę
          </button>
        </div>
      </div>
            ...
            {rows.map(({ inv, uiStatus, clientName }) => (
              <div key={inv.id} className="i-row">
                ...
                <div className="i-actions">
                  ...
                  <button className="invoices-button-primary ghost" onClick={() => openMarkModal(inv)}>
                    Oznacz
                  </button>
                </div>
              </div>
        ...
        >
          <div className="invoice-modal">
            <div className="invoice-modal-top">
              <h2 className="invoice-modal-title">Wystaw fakturę</h2>
            ...
            {createError && <div className="invoice-modal-message error">⚠️ {createError}</div>}

            <div className="invoice-modal-actions">
              <button className="btn-secondary" onClick={closeCreate} disabled={creating}>
                Anuluj
              </button>
              <button className="invoices-button-primary" onClick={submitCreate} disabled={creating}>
      ...
      {openPreview && selected && (
        ...
        >
          <div className="invoice-modal">
            <div className="invoice-modal-top">
              <h2 className="invoice-modal-title">Podgląd faktury</h2>
            ...
            <div style={{ marginTop: 10, color: '#ddd' }}>
              ...
              <div style={{ marginTop: 10, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
                ...
                <button className="invoices-button-primary ghost" onClick={() => openMarkModal(selected)}>
                  Oznacz
                </button>
              </div>
            </div>
      ...
      {openMark && selected && (
        ...
        >
          <div className="invoice-modal">
            <div className="invoice-modal-top">
              <h2 className="invoice-modal-title">Zmień status</h2>
            ...
            <div className="invoice-modal-grid" style={{ marginTop: 12 }}>
              <div className="invoice-field" style={{ gridColumn: '1 / -1' }}>
                <label>Status</label>
            ...
            {markError && <div className="invoice-modal-message error">⚠️ {markError}</div>}

            <div className="invoice-modal-actions">
              <button className="btn-secondary" onClick={closeMark} disabled={marking}>
                Anuluj
              </button>
              <button className="invoices-button-primary" onClick={submitMark} disabled={marking}>
