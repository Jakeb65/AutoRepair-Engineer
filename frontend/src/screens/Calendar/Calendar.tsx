...
export default function Calendar() {
  ...
  const convertToOrder = async () => {
    ...
    if (selectedAppointment.customer_id == null || selectedAppointment.vehicle_id == null) {
      setUpdateError('Wizyta nie ma przypisanego klienta lub pojazdu')
      return
    }
    ...
    <div className="calendar-container">
      <div className="calendar-header">
        ...
        <div className="calendar-actions">
          <button className="calendar-button-primary" onClick={() => setOpen(true)}>
            Umów wizytę
          </button>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="calendar-button-primary" onClick={submitCreate} disabled={saving}>
