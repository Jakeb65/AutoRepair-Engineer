    ...
    <div className="warehouse-container">
      <div className="warehouse-header">
        ...
        <div className="warehouse-actions">
          ...
          <button className="warehouse-button-primary" onClick={openAdd}>
            ➕ Dodaj część
          </button>
        </div>
      </div>
          ...
          return (
            <div key={p.id} className="part-card">
              <div className="part-top">
                ...
                <div className={`part-stock ${low ? 'low' : 'ok'}`}>{p.stock} szt.</div>
              </div>
              ...
              <div className="part-actions">
                ...
                <button className="warehouse-button-primary ghost" onClick={() => openOrderModal(p)}>
                  Zamów
                </button>
                <button className="warehouse-button-primary ghost" onClick={() => onDelete(p)} title="Usuń część">
                  Usuń
                </button>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="warehouse-button-primary" onClick={submitPart} disabled={saving}>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="warehouse-button-primary" onClick={submitReserve} disabled={reserving}>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="warehouse-button-primary" onClick={submitOrder}>
                Złóż zamówienie (UI)
              </button>
            </div>
          </div>
