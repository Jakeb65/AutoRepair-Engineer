    ...
    <div className="customers-container">
      <div className="customers-header">
        ...
        <div className="customers-actions">
          ...
          />
          <button className="customers-button-primary" onClick={() => setOpenAddCustomer(true)}>
            Dodaj klienta
          </button>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="customers-button-primary" onClick={submitAddCustomer} disabled={savingCustomer}>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="customers-button-primary" onClick={submitAddOrder} disabled={savingOrder}>
