    ...
    <div className="orders-container">
      <div className="orders-header">
        ...
        <div className="orders-actions">
          ...
          />
          <select className="orders-select" value={status} onChange={(e) => setStatus(e.target.value as any)}>
          ...
          return (
            <div key={o.id} className="order-card">
              ...
              <div className="card-actions">
                <button className="orders-button-secondary btn-secondary" onClick={() => openDetails(o)}>
                  Szczegóły
                </button>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
              ...
              <button className="orders-button-secondary btn-secondary" onClick={closeModal} disabled={saving}>
                Zamknij
              </button>
            </div>
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="orders-button-primary" onClick={submitCreate} disabled={saving}>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
              ...
              <button className="orders-button-secondary btn-secondary" onClick={closeDetails} disabled={detailsSaving}>
                Zamknij
              </button>
            </div>
            ...
            <div style={{ marginTop: 10, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <select className="orders-select" value={editStatus} onChange={(e) => setEditStatus(e.target.value as any)}>
                  <option value="oczekujące">Oczekujące</option>
                  <option value="w trakcie">W trakcie</option>
                  <option value="zakończone">Zakończone</option>
                  <option value="anulowane">Anulowane</option>
            ...
            <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="orders-button-primary" onClick={submitDetailsSave} disabled={detailsSaving}>
